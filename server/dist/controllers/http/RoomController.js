...
var RoomController = {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        room = rooms_1.createRoom(entry, encrypted_password);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        rooms_1.joinRoom(id, subscribers_1.getSubscriber(uuid));
                        res.sendStatus(200);
                        return [2 /*return*/];
                }
            });
    ...
    leave: function (req, res, next) {
        ...
        rooms_1.leaveRoom(id, subscribers_1.getSubscriber(uuid));
        res.sendStatus(200);
    }
};
